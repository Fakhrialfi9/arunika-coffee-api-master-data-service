...
export class MasterDataCrudUseCase {
  ...
  create(entity: MasterDataEntityName, input: MasterDataWrite) {
    return this.service.create(entity, input);
  }
  get(entity: MasterDataEntityName, identifier: CrudRequest) {
    return this.service.get(entity, identifier);
  }
  list(entity: MasterDataEntityName, query?: MasterDataListQuery) {
  ...
  delete(entity: MasterDataEntityName, identifier: CrudRequest) {
