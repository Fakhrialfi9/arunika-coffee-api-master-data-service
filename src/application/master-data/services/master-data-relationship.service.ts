...
export class MasterDataRelationshipService {
  ...
  async sensoryFlavors(
    ...
    if (!profile)
      throw new MasterDataNotFoundError('sensoryProfile was not found');
    ...
    const [items, total] = await Promise.all([
      ...
      repository
        .list({ page: 1, limit: 1, filters: { sensoryProfileId } })
  ...
  private async collection(
    ...
    if (!parent)
      throw new MasterDataNotFoundError(`${parentEntity} was not found`);
